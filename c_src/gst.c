...
int main(int argc, char *argv[]) {
    ...
    if (g_strcmp0(format, "fmp4") == 0 || g_strcmp0(format, "mp4") == 0) {
        ...
        pipeline_str = g_strdup_printf(
            ...
            "queue max-size-time=300000000 max-size-buffers=0 max-size-bytes=0 leaky=downstream ! x264enc bitrate=4000 "
        ...
        pipeline_str = g_strdup_printf(
            ...
            "raw_vtee. ! queue max-size-time=300000000 max-size-buffers=0 max-size-bytes=0 leaky=downstream ! x264enc bitrate=3000 "
