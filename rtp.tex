...
\subsubsection{Scenario A: Idle Signaling \& TURN Relay (No GStreamer Mixers)}
...
\subsubsection{Scenario B: Active Recording \& Compositing (Mixed Workload)}
...
\subsubsection{Target Scenario: Scaling to 50 Concurrent Active Video Rooms}
